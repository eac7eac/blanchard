(() => {
  ...
  const btn = document.querySelector(".section-events__more-btn");

  const sliderMobileParams = {
    paginationClassName: "events-pagination",
    cardsContainerName: "section-events__slider",
    cardsWrapName: "section-events__slider-list",
    card: "section-events__slide-item",
